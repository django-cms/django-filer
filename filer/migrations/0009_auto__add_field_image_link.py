...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('filer_image', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.link'
        db.delete_column('filer_image', 'link')
