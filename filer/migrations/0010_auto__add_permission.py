...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('filer_permission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('who', self.gf('django.db.models.fields.CharField')(default='anonymous', max_length=32)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='filer_permissions', null=True, to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='filer_permissions', null=True, to=orm['auth.Group'])),
            ('subject', self.gf('django.db.models.fields.CharField')(default='root', max_length=32)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('filer_permission')
    ...
    models = {
        ...
        'filer.oldfolderpermission': {
            'Meta': {'object_name': 'OldFolderPermission'},
        ...
        'filer.permission': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_inheritable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'subject': ('django.db.models.fields.CharField', [], {'default': "'root'", 'max_length': '32'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'filer_permissions'", 'null': 'True', 'to': "orm['auth.User']"}),
            'who': ('django.db.models.fields.CharField', [], {'default': "'anonymous'", 'max_length': '32'})
        }
    }
