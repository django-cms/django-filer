...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('filer_video', (
            ...
            ('conversion_status', self.gf('django.db.models.fields.CharField')(default='new', max_length=50)),
            ('conversion_output', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
