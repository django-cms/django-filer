...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('filer_image', (
            ...
            ('has_all_mandatory_data', orm['filer.Image:has_all_mandatory_data']),
        ...
        db.create_table('filer_file', (
            ...
            ('_file', orm['filer.File:_file']),
            ('_file_type', orm['filer.File:_file_type']),
    ...
    models = {
        ...
        'filer.file': {
            ...
            '_file_type': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'folder': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'file_files'", 'null': 'True', 'to': "orm['filer.Folder']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
