...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'filer_permission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('who', self.gf('django.db.models.fields.CharField')(default='group', max_length=32)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='filer_permission_set', null=True, to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='filer_permissions_set', null=True, to=orm['auth.Group'])),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='permission_set', null=True, to=orm['filer.Folder'])),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='permission_set', null=True, to=orm['filer.File'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'filer_permission')
    ...
    models = {
        ...
        'filer.permission': {
            ...
            'can_edit': ('django.db.models.fields.SmallIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'can_read': ('django.db.models.fields.SmallIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'file': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'permission_set'", 'null': 'True', 'to': u"orm['filer.File']"}),
            'folder': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'permission_set'", 'null': 'True', 'to': u"orm['filer.Folder']"}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'filer_permissions_set'", 'null': 'True', 'to': u"orm['auth.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'filer_permission_set'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'who': ('django.db.models.fields.CharField', [], {'default': "'group'", 'max_length': '32'})
        }
    }
