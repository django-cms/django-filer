'use strict';
/* globals django, _actions_icnt, interpolate, ngettext, gettext */
/* jshint eqeqeq: false */

/* OLD SCHOOL JAVASCRIPT HERE, WILL BE REPLACED SOON */
(function ($) {
    var lastChecked;
    ...
    $.fn.actions = function (opts) {
        ...
        $(this).filter(':checked').each(function () {
            ...
            updateCounter();
            if (parseInt($(options.acrossInput).val()) == 1) {
                showClear();
            }
        });
        ...
        $('form#changelist-form input[name="_save"], .js-navigator-form input[name="_save"]').click(function () {
            ...
            if (action_changed) {
                if (list_editable_changed) {
                    return confirm(gettext('You have selected an action, ' +
                        'but you haven&#39;t saved your changes to individual fields yet. ' +
                        'Please click OK to save. ' +
                        'You&#39;ll need to re-run the action.'));
                } else {
                    return confirm(gettext('You have selected an action, and you haven&#39;t made any ' +
                        'changes on individual fields. ' +
