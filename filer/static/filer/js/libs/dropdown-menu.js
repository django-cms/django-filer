...
(function ($) {
        ...
        Dropdown.prototype.toggle = function (e) {
            ...
            if (!isActive) {
                if ('ontouchstart' in document.documentElement && !$parent.closest('.navbar-nav').length) {
                    ...
                    $(document.createElement('div')).addClass('filer-dropdown-backdrop').insertAfter($(this)).on('click', clearMenus)
                }
    ...
    function Plugin(option) {
        return this.each(function () {
            ...
            if (!data) $this.data('bs.filer-dropdown', (data = new Dropdown(this)));
    ...
    .on('click.bs.filer-dropdown.data-api', '.filer-dropdown form', function (e) { e.stopPropagation() })
