...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='image',
            name='file_ptr',
            field=models.OneToOneField(parent_link=True, primary_key=True, related_name='custom_image_image_file', serialize=False, to='filer.File', on_delete=models.CASCADE),
        ),
        migrations.AlterField(
            model_name='image',
