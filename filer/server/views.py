...
from ..utils.filer_easy_thumbnails import original_filename_candidates
...
def serve_protected_thumbnail(request, path):
    ...
    """
    # Thumbnails generated by filer < 3.6 use a different naming scheme, so more
    # than one source file name may have to be tried.
    for source_path in original_filename_candidates(path):
        try:
