...
class ThumbnailToOriginalFilenameTestCase(TestCase):
    ...
    def test_normal_thumbnail_name(self):
        self.assertEqual(
            thumbnail_to_original_filename("foo.jpg.200x200_q85.jpg"),
            "foo.jpg",
        )

    def test_legacy_thumbnail_name(self):
    ...
    def test_name_without_size_returns_none(self):
        """Both naming schemes start the options part with the size."""
        self.assertIsNone(thumbnail_to_original_filename("__opts.jpg"))
